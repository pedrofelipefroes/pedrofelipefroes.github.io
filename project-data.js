...
const data = [
	...
	// 	],
	// 	role: "I was the leading designer of the project during its first and second versions, responsible for the blocks' design and consulting on its front-end\u00A0architecture.",
	// 	team: [
	...
	// 	],
	// 	role: "This project was co-led by myself in close collaboration with Avenue Code Director of Creative Services and Head of\u00A0Design.",
	// 	team: [
	// 		"Research and concept by Holly Camponez (Director of Creative Services), Bernardo Matos (Head of Design), and Froes (Design Lead). Brand artwork and collaterals by Froes, Marina Ferreira (Visual Designer), and Aurelízia Lemos (Product Designer). Landing pages and email development by Froes. Rollout campaign by Avenue Code Marketing and HR\u00A0teams.",
	// 	],
	// },
	// {
	// 	url: "/about",
